package anifire.components.char_editor
{
   ...
   public class CcComponentThumbThumbnail extends Canvas
   {
      ...
      public function init(param1:CcComponentThumbDetailThumbnail, param2:Number, param3:Number, param4:CcComponentThumb, param5:String) : void
      {
      ...
      public function initNullThumbnail(param1:CcComponentThumbDetailThumbnail, param2:Number, param3:Number, param4:String, param5:String) : void
      {
         if(this.thumbnailContainer != null)
         {
            this.thumbnailContainer.removeAllChildren();
